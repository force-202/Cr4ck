...
\x1b[1;94m────────────────────────────────────────────────────
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] Author   : AURELIO JOERLY 
\x1b[1;97m [\x1b[1;92m•\x1b[1;94m•\x1b[1;97m] Team     : SILENT-FORCE 
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] Facebook : https://www.facebook.com/joeryl
\x1b[1;94m────────────────────────────────────────────────────""")
...
\x1b[1;91m  •\x1b[1;93m•\x1b[1;92m•\x1b[1;97m ╚═════╝╚═╝  ╚═╝     ╚═╝ ╚═════╝╚═╝  ╚═╝\x1b[1;92m •\x1b[1;93m•\x1b[1;91m•
\x1b[1;94m────────────────────────────────────────────────────
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Author   : AURELIO JOERLY 
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Team     : SILENT-FORCE 
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Facebook : https://www.facebook.com/joeryl
\x1b[1;94m────────────────────────────────────────────────────""")
...
def moch_yayan():
    ...
    print("\033[97m [\033[96m03\033[97m] Joined Grup Fb  SILENT FORCE ")
    ...
    if yayan == "1" or yayan =="01":
         ...
         def masuk():
             ...
             if "mbasic_logout_button" in str(ismi):
                     if "What are you thinking about now?" in str(ismi):
                             with open("cookies","w") as f:
                                     f.write(cek["cookie"])
                     else:
                           print("\033[1;97m[\033[1;94m•\033[1;97m] \033[00mChange language, please wait\033[1;91m!!\033[00m")
                           try:
                                  requests.get(mbasic.format(parser(ismi,"html.parser").find("a",string="language Philippines")["href"]),cookies=cek)
                           except:
                                  pass
                     try:
                  ...
                  os.system("xdg-open https://www.facebook.com/joeryl.aurelio.77") 
         ...
         def getid(url):
             ...
             if 'See Other Themes' in str(raw):
                 getid(mbasic.format(parser(raw,'html.parser').find('a',string='See Other Themes')['href']))
             return id
         def fromlikes(url):
             try:
         ...
         def getlike(react):
             ...
             if 'See Results' in str(like):
                 getlike(mbasic.format(parser(like,'html.parser').find('a',string="See Results")["href"]))
             return id
         def bysearch(option):
             ...
             for user in users:
                  ...
                  print(f"\r\033[1;97m [\033[1;94m•\033[1;97m] \033[1;96m{str(len(id))} \033[1;97mProcess Of Retrieving ID... ",end="")
             if "See Results Further" in str(search):
                  bysearch(parser(search,'html.parser').find("a",string="See Results Further")["href"])
             return id
         def grubid(endpoint):
             ...
             for user in users:
                 ...
                 print(f"\r\033[1;97m [\033[1;94m•\033[1;97m] \033[1;96m{str(len(id))} \033[1;97mProcess Of Retrieving ID... ",end="")
             if "See Results" in str(grab):
                 grubid(mbasic.format(parser(grab,"html.parser").find("a",string="See Results")["href"]))
             return id
         ...
         os.system("xdg-open https://www.facebook.com/profile.php?id=100086027776763") 
         yayanxd()
         ...
         aahh("\n\033[1;92m Thank you for using my tools.\n  Don't forget Add me in Facebook account \n\n")
         os.system('xdg-open https://www.facebook.com/profile.php?id=100086027776763')
         exit()                   	
